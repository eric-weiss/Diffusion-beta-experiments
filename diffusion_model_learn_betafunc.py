...
if plot_reverse_process:
	...
	pp.axes(xlim=(-xlm, xlm), ylim=(-ylm, ylm))
	pp.scatter(samples[0,:nsamps/10,0],samples[0,:nsamps/10,1],c='r',alpha=.2)
	pp.savefig('swiss_p_1.pdf')
	pp.close()
	pp.figure(2, figsize=(2.5,2.5))
	#pp.suptitle('Reverse Process Samples at t=T/2')
	pp.axes(xlim=(-xlm, xlm), ylim=(-ylm, ylm))
	pp.scatter(samples[nsteps/2,:nsamps/10,0],samples[nsteps/2,:nsamps/10,1],c='r',alpha=.2)
	pp.savefig('swiss_p_half.pdf')
	pp.close()
	pp.figure(3, figsize=(2.5,2.5))
	#pp.suptitle('Reverse Process Samples at t=0')
	pp.axes(xlim=(-xlm, xlm), ylim=(-ylm, ylm))
	pp.scatter(samples[-1,:nsamps/10,0],samples[-1,:nsamps/10,1],c='r',alpha=.2)
	...
	pp.axes(xlim=(-xlm, xlm), ylim=(-ylm, ylm))
	pp.scatter(forward_data[0,:nsamps/10,0],forward_data[0,:nsamps/10,1],c='b',alpha=.2)
	pp.savefig('swiss_q_1.pdf')
	pp.close()
	pp.figure(5, figsize=(2.5,2.5))
	#pp.suptitle('Forward Process Samples at t=T/2')
	pp.axes(xlim=(-xlm, xlm), ylim=(-ylm, ylm))
	pp.scatter(forward_data[nsteps/2,:nsamps/10,0],forward_data[nsteps/2,:nsamps/10,1],c='b',alpha=.2)
	pp.savefig('swiss_q_half.pdf')
	pp.close()
	pp.figure(6, figsize=(2.5,2.5))
	#pp.suptitle('Forward Process Samples at t=0')
	pp.axes(xlim=(-xlm, xlm), ylim=(-ylm, ylm))
	pp.scatter(forward_data[-1,:nsamps/10,0],forward_data[-1,:nsamps/10,1],c='b',alpha=.2)
