...
if plot_reverse_process:
	...
	pp.axes(xlim=(-xlm, xlm), ylim=(-ylm, ylm))
	pp.scatter(samples[0,:nsamps/10,0],samples[0,:nsamps/10,1],c='r',s=dsize,alpha=.2)
	pp.savefig('swiss_p_1.pdf')
	pp.close()
	pp.figure(2, figsize=(2.5,2.5))
	#pp.suptitle('Reverse Process Samples at t=T/2')
	pp.axes(xlim=(-xlm, xlm), ylim=(-ylm, ylm))
	pp.scatter(samples[nsteps/2,:nsamps/10,0],samples[nsteps/2,:nsamps/10,1],c='r',s=dsize,alpha=.2)
	pp.savefig('swiss_p_half.pdf')
	pp.close()
	pp.figure(3, figsize=(2.5,2.5))
	#pp.suptitle('Reverse Process Samples at t=0')
	pp.axes(xlim=(-xlm, xlm), ylim=(-ylm, ylm))
	pp.scatter(samples[-1,:nsamps/10,0],samples[-1,:nsamps/10,1],c='r',s=dsize,alpha=.2)
	...
	pp.axes(xlim=(-xlm, xlm), ylim=(-ylm, ylm))
	pp.scatter(forward_data[0,:nsamps/10,0],forward_data[0,:nsamps/10,1],c='b',s=dsize,alpha=.2)
	pp.savefig('swiss_q_1.pdf')
	pp.close()
	pp.figure(5, figsize=(2.5,2.5))
	#pp.suptitle('Forward Process Samples at t=T/2')
	pp.axes(xlim=(-xlm, xlm), ylim=(-ylm, ylm))
	pp.scatter(forward_data[nsteps/2,:nsamps/10,0],forward_data[nsteps/2,:nsamps/10,1],c='b',s=dsize,alpha=.2)
	pp.savefig('swiss_q_half.pdf')
	pp.close()
	pp.figure(6, figsize=(2.5,2.5))
	#pp.suptitle('Forward Process Samples at t=0')
	pp.axes(xlim=(-xlm, xlm), ylim=(-ylm, ylm))
	pp.scatter(forward_data[-1,:nsamps/10,0],forward_data[-1,:nsamps/10,1],c='b',s=dsize,alpha=.2)
	...
	#pp.show()
	pp.figure(9, figsize=(3,3))
	pp.hexbin(samples[-1,:,0],samples[-1,:,1], extent=[-2, 2, -2, 2],gridsize=80)
	#pp.axis([-2,2,-2,2])
	pp.savefig('p_0_hist.pdf')
	pp.close()
	pp.figure(10, figsize=(3,3))
	pp.hexbin(data[:,0], data[:,1], extent=[-2, 2, -2, 2],gridsize=80)
	#pp.axis([-2,2,-2,2])
